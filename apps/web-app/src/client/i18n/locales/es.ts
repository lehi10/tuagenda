...
export const es: Translations = {
  ...
  booking: {
    ...
    date: {
      ...
      hint: "Elige el día que prefieras",
    ...
    time: {
      ...
      hint: "Selecciona la hora que mejor te convenga",
      available: "disponible",
      selected: "Seleccionado",
      noSlots: "No hay horarios disponibles para esta fecha",
      timezoneUser: "Horarios en tu zona horaria",
      timezoneBusiness: "Horarios en zona horaria del negocio",
      errorLoading:
    ...
    payment: {
      ...
      confirmOnsite: "Confirmar reserva ✓",
      creatingAppointment: "Creando cita...",
      whatsappConfirmation: "Recibirás confirmación por WhatsApp y email.",
    },
    confirmation: {
