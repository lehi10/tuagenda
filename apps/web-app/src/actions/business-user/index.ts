/**
 * BusinessUser Server Actions
 *
 * Export all business-user actions from this file
 */

export { createBusinessUser } from "./create-business-user.action";
export { updateBusinessUser } from "./update-business-user.action";
