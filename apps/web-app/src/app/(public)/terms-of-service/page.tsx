      ...
      <main className="container mx-auto max-w-4xl px-4 py-12">
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <section>
            ...
            <p>
              TuAgenda offers various subscription plans. By subscribing to a
          ...
          <section>
            ...
            <p>
              ...
              measures to protect your information. You retain all rights to
              your data, and you may export or delete your data at any time.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, TuAgenda shall not be
