              ...
              <ScrollReveal key={index} delay={index * 100}>
                ...
                >
                  ...
                  <div className={index % 2 === 1 ? "lg:col-start-2" : ""}>
                    <div className="mb-6">
                      <div
                        className={`mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br ${industry.color} shadow-lg`}
                      >
          ...
          <div className="mx-auto mt-12 grid max-w-6xl gap-6 md:grid-cols-3 md:gap-8">
            {[1, 2, 3].map((i) => (
              <ScrollReveal key={i} delay={i * 100}>
                <div className="rounded-xl border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md lg:p-8">
