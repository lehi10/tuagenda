...
export default function PaymentsPage() {
  ...
  return (
    <>
                ...
                >
                  ...
                  <div className={index % 2 === 1 ? "lg:col-start-1" : ""}>
                    <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-xl">
                      <div className="aspect-[4/3] bg-gradient-to-br from-indigo-500/10 via-background to-purple-500/10 p-8">
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-background via-indigo-500/5 to-background py-16 md:py-24">
