...
export function renderAppointmentCreated(data: Data): RenderedEmail {
  return {
    subject: `Tu cita en ${data.businessName} está confirmada`,
    html: `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding:40px 32px;">
              ...
              <p style="margin:0 0 32px;font-size:16px;color:#52525b;">Tu cita ha sido confirmada. Aquí están los detalles:</p>
              ...
              <p style="margin:0 0 8px;font-size:14px;color:#52525b;">¿Necesitas reagendar o tienes alguna pregunta?</p>
              <p style="margin:0;font-size:14px;color:#52525b;">Contáctanos al <strong>${data.businessPhone}</strong>.</p>
            </td>
          </tr>
